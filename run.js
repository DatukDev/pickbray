...
async function saveNumbersToDatabase(numbers) {
    ...
    try {
        // Simpan semua nomor, termasuk yang sudah ada
        ...
        log(`Batch ${numbers.length} nomor berhasil disimpan ke database`, 'success');

        return {
            successCount: numbers.length,
            duplicateCount: 0 // Tidak menghitung duplikat lagi
        };
